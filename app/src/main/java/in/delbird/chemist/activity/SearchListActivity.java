...
public class SearchListActivity extends BaseCartCopyActivity implements View.OnClickListener {
  ...
  //  TextView textSelectChemist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shopListAdapter = new ShopListAdapter(SearchListActivity.this, shopModelArrayList);
        ...
        mForwardSearch=(ImageView)findViewById(R.id.iv_forward);
        mForwardSearch.setOnClickListener(this);
    ...
    private void call_list() {
        ...
        if (gps.canGetLocation()) {
            ...
            if (firstCall) {
                ...
                dialogUtil.progressDialog(SearchListActivity.this, "Fetching Shops..");
                String retailer_id = sharedPreferences.getString(Constants.RETAILER_IDS, "0");
                if (retailer_id.equalsIgnoreCase(""))
                    retailer_id = "0";
                url = Constants.SHOP_LIST_URL+"lat=" + String.valueOf(latitude) + "&" + "lon=" + String.valueOf(longitude) + "&category_id=" + "17" + "&next_page_token=" + "&retailer_id=" + retailer_id +"&product_name=";
...
//        swipeRefreshLayout.setRefreshing(false);
    ...
    public void getKonotorChat() {
        Konotor.getInstance(getApplicationContext())
                .launchFeedbackScreen(SearchListActivity.this);
        chatCountTV.setVisibility(View.INVISIBLE);
    }
...
//        swipeRefreshLayout.setOnRefreshListener(this);
        ...
        chatIV.setImageResource(R.drawable.fav_chemist);
