...
public class DoctorPrescriptionListActivity extends AppCompatActivity {
    ...
    DoctorPrescriptionListAdapter doctorPrescriptionListAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTitle.setText("doctor Prescription");
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        doctorPrescriptionListAdapter = new DoctorPrescriptionListAdapter(this,shopModelArrayList);
    ...
    private void getShopList() {
        String url = Constants.prescriptionsUrl;
        url = String.format(url,sharedPreferences.getString(Constants.USER_ID,""));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                shopModelArrayList = new ArrayList<>(Arrays.asList(new GsonBuilder().create().fromJson(response, DoctorPrescriptionModel[].class)));
