...
//            }
    ...
    private static void setMultiPartBody(HttpEntityEnclosingRequestBase httpRequest,
        ...
        if (request instanceof MultiPartRequests == false) {
            return;
        }

        MultipartEntity multipartEntity = new MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE);
        //Iterate the fileUploads
        Map<String, File> fileUpload = ((MultiPartRequests) request).getFileUploads();
        ...
        Map<String, String> stringUpload = ((MultiPartRequests) request).getStringUploads();
