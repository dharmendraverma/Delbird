...
public class ShopListAdapter extends RecyclerView.Adapter<ShopListAdapter.RecyclerViewHolders> {
...
//        notifyItemRangeChanged(0,updatedSize);
    ...
    public void changeData(ArrayList<ShopModel> shopModelArrayList) {
        this.shopModelArrayList = shopModelArrayList;
        notifyDataSetChanged();
    }
    ...
    public RecyclerViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_row_shop_list, null);
        ...
        if (shopModelArrayList != null) {
           ...
           // holder.medicineQuantity.setText(shopModel.getMedicineQuantity());
            ...
            if(shopModel.getRetailer()!=null) {
                ...
                holder.sellPrice.setText((int)(shopModel.getPrice() * (1.0 - (shopModel.getRetailer().getPriceDiscounted() / 100.0))) + "");
                if(shopModel.getRetailer().getPriceDiscounted()==0){
                   ...
                   // holder.ivSell.setVisibility(View.VISIBLE);
                    ...
                    holder.ivMrp.setVisibility(View.GONE);
                  //  holder.mrp.setBackgroundResource(R.drawable.blank);
                }
                else{
                    holder.mrp.setVisibility(View.VISIBLE);
                    holder.discount.setVisibility(View.INVISIBLE);
                    holder.ivDiscount.setVisibility(View.GONE);
                    holder.ivMrp.setVisibility(View.VISIBLE);
                }
            ...
            holder.ivPlus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (((ShopListActivity) context).getRetailerIdForList().isEmpty()) {
                        Toast.makeText(context, "Please Select Your  Chemist First", Toast.LENGTH_SHORT).show();
                    } else {
